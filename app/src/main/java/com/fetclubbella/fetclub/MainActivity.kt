...
import com.fetclubbella.fetclub.Fragments.ChatFragment
import com.fetclubbella.fetclub.Fragments.LikeFragment
import com.fetclubbella.fetclub.Fragments.ProfileFragment
import com.fetclubbella.fetclub.databinding.ActivityMainBinding
...
runOnUiThread{
    ...
    binding.home.setImageResource(R.drawable.homenew);
}
        ...
        binding.like.setOnClickListener {
            runOnUiThread {
                ...
                binding.like.setImageResource(R.drawable.group_169);
                binding.message.setImageResource(R.drawable.group_102);
                binding.profile.setImageResource(R.drawable.group_103);
        ...
        binding.message.setOnClickListener {
            runOnUiThread{
                ...
                binding.home.setImageResource(R.drawable.group_100);
                binding.like.setImageResource(R.drawable.group_101);
                binding.message.setImageResource(R.drawable.messagenew);
                binding.profile.setImageResource(R.drawable.group_103);
        ...
        binding.profile.setOnClickListener {
            runOnUiThread{
                ...
                binding.like.setImageResource(R.drawable.group_101);
                binding.message.setImageResource(R.drawable.group_102);
                binding.profile.setImageResource(R.drawable.profilenew);
