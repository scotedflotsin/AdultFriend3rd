...
import com.adultfriendbella.adultfre.Fragments.ChatFragment
import com.adultfriendbella.adultfre.Fragments.LikeFragment
import com.adultfriendbella.adultfre.Fragments.ProfileFragment
import com.adultfriendbella.adultfre.databinding.ActivityMainBinding
...
runOnUiThread{
    ...
    binding.home.setImageResource(R.drawable.adulthomeimage);
}
        ...
        binding.like.setOnClickListener {
            runOnUiThread {
                ...
                binding.like.setImageResource(R.drawable.adultlike);
                binding.message.setImageResource(R.drawable.group_102);
                binding.profile.setImageResource(R.drawable.group_103);
        ...
        binding.message.setOnClickListener {
            runOnUiThread{
                ...
                binding.home.setImageResource(R.drawable.group_100);
                binding.like.setImageResource(R.drawable.group_101);
                binding.message.setImageResource(R.drawable.adultmesage);
                binding.profile.setImageResource(R.drawable.group_103);
        ...
        binding.profile.setOnClickListener {
            runOnUiThread{
                ...
                binding.like.setImageResource(R.drawable.group_101);
                binding.message.setImageResource(R.drawable.group_102);
                binding.profile.setImageResource(R.drawable.adultprofile);
