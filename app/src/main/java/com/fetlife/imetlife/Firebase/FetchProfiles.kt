package com.fetlife.imetlife.Firebase
...
class FetchProfiles {
    ...
    fun fetchProfiles(genderFilter: String, limit: Int, page: Int, callback: (List<Profile>?, String?) -> Unit) {
        ...
        var query = db.collection("users")
            .whereEqualTo("gender", genderFilter)
            .orderBy("gender")  // Order the results by username or another field
            .limit(12.toLong()) // Limit the number of results per page
