...
import com.fetlifenew.imetlife.RedirectActivity
import com.fetlifenew.imetlife.Utils.CustomIntent
import com.fetlifenew.imetlife.databinding.ActivitySplashScreenBinding
...
class Splash_Screen : AppCompatActivity() {
    ...
    private fun checkAppSettings() {
        ...
        db.collection("appsettings").document("1odbtWwsp5pE7INj2eNt")
            .get()
            .addOnSuccessListener { document ->
                ...
                if (document.exists()) {
                    ...
                    val currentStatus = document.getString("currentStatus") ?: "false"

                    if (currentStatus.toString().equals("true")) {
